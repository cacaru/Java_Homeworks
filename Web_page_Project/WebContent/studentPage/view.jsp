				...
				<tbody>
					...
					<tr>
						...
						<td align="left" style="margin-left: 15%;">
							<a href="./filedown.jsp?&Name=<%= lboard.getFile() %> "> <%= lboard.getFile() %> </a>
						</td>
					</tr>
					<tr align="right">
						<td>
						...
						<td>
							<% if ( division == 1 )  {%>
							<a href="./stu_studynotice.jsp?ID=<%=ID %>&lid=<%=Lid %>" class="b_likeButton">돌아가기</a>
							<% } if ( division == 2 ) { %>
							<a href="./stu_studySupport.jsp?ID=<%=ID %>&lid=<%=Lid %>" class="b_likeButton">돌아가기</a>
							<% } %>
						</td>
					</tr>
				</tbody>
